...
[`localization.md`](localization.md); the complete per-case official results are in
[`localization-results.parquet`](localization-results.parquet).
...
- Deleted both ad-hoc Git-history shell runners after freezing [replication notes](../../replication/README.md)
  and [`replication.parquet`](../../replication/replication.parquet).
...
- Replaced the 924-line tree-reuse measurement harness with a 67-line normal
  Flix law while preserving the complete 208-cell [tree-reuse report](../tree-reuse.md).
